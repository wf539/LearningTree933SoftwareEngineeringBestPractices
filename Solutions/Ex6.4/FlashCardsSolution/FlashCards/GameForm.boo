...
partial class GameForm:
	...
	private def game_FlashCardChanged(sender as object, flashCard as FlashCard):
		FlashCardPictureBox.Image = flashCard.Picture()
		MessageLabel.Text = flashCard.Message()
